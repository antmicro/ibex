...
CC = $(TOOLCHAIN_LAUNCHER) riscv32-unknown-elf-gcc
# Flag : LD
#	Use this flag to define compiler to use
LD = $(TOOLCHAIN_LAUNCHER) riscv32-unknown-elf-ld
# Flag : AS
#	Use this flag to define compiler to use
AS = $(TOOLCHAIN_LAUNCHER) riscv32-unknown-elf-as
# Flag : CFLAGS
...
port_postbuild:
	$(TOOLCHAIN_LAUNCHER) riscv32-unknown-elf-objdump -SD $(OPATH)coremark.elf > $(OPATH)coremark.dis
